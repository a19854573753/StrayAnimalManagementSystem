...
* [Bootstrap](getbootstrap.com/) v. 3.2.0+
...
The user interface of all versions except the jQuery UI version is built with [Bootstrap](getbootstrap.com/) and icons from [Glyphicons](glyphicons.com/).
...
If you have a question that another developer might help you with, please post to [Stack Overflow](stackoverflow.com/questions/tagged/blueimp+jquery+file-upload) and tag your question with `blueimp jquery file upload`.
