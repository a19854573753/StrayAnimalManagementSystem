...
[DEMO](overtrue.me/share.js/)

或者直接浏览我的博客 overtrue.me 或者 laravel.so 内容页查看效果。
...
source              : '', // 来源（QQ空间会用到）, 默认读取head标签：<meta name="site" content="overtrue" />
